...
if __name__ == '__main__':
    ...
    if os.path.isdir(args.data):
        ...
        for jpg in tqdm(jpg_list):
            ...
            assert not os.path.exists(jpg.replace('.transformed.jpg', '.' + args.feat_suffix)), \
                jpg.replace('.transformed.jpg', '.' + args.feat_suffix)
            with open(jpg.replace('.transformed.jpg', '.' + args.feat_suffix), 'wb') as f:
